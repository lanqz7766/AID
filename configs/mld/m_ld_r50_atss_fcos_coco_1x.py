...
teacher_ckpt_1 = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/gfl_atss_r101_2x_coco/epoch_24.pth'
...
model = dict(
    ...
    teacher_config_1='configs/gfl_kitti/atss_gfl_r101_2x_coco.py',
