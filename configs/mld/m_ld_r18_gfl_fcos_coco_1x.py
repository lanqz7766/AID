...
teacher_ckpt_2 = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/fcous_gfl_r101_2x_center_coco/epoch_24.pth'


model = dict(
    type='MKnowledgeDistillationSingleStageDetector',
    teacher_config_1='configs/gfl_kitti/gfl_r101_fpn_mstrain_2x_coco.py',
    teacher_config_2='configs/gfl_kitti/fcos_gfl_r101_2x_center_coco.py',
