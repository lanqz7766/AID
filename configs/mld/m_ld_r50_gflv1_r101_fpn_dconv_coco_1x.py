...
teacher_ckpt_1 = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/gfl_r101_fpn_dconv_c3-c5_mstrain_2x_coco/epoch_24.pth'
teacher_ckpt_2 = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/gfl_r101_fpn_mstrain_2x_coco/epoch_24.pth'
#teacher_ckpt_3 = '/users/PCS0252/lanqz7766/mmdetection/KD_kitti_results/gfl_r50_fpn_1x_kitti/epoch_12.pth'
model = dict(
    ...
    teacher_config_2='configs/gfl_kitti/gfl_r101_fpn_mstrain_2x_coco.py',
#    teacher_config_3='configs/gfl_kitti/gfl_r50_fpn_1x_coco.py',
...
#    teacher_ckpt_3=teacher_ckpt_3,
    ...
    bbox_head=dict(
        ...
        loss_kd=dict(
            type='KnowledgeDistillationKLDivLoss', loss_weight=0.15, T=2),
        reg_max=16,
