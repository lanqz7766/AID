...
teacher_ckpt_1 = '/users/PCS0252/lanqz7766/mmdetection/KD_Test_results/retinanet/retinanet_r101_2x_kitti/epoch_24.pth'
...
model = dict(
    ...
    teacher_config_1='configs/gfl_kitti/retinagfl_r101_2x_kitti.py',
