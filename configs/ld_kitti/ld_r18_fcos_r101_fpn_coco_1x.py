...
teacher_ckpt = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/fcous_gfl_r101_2x_center_coco/epoch_24.pth'
model = dict(
    type='KnowledgeDistillationSingleStageDetector',
    teacher_config='configs/gfl_kitti/fcos_gfl_r101_2x_center_coco.py',
