...
teacher_ckpt = '/users/PCS0252/lanqz7766/MMdetection/checkpoints/gfl_atss_r101_2x_coco/epoch_24.pth'

model = dict(
    type='KnowledgeDistillationSingleStageDetector',
    teacher_config='configs/gfl_kitti/atss_gfl_r101_2x_coco.py',
...
optimizer = dict(type='SGD', lr=0.0045, momentum=0.9, weight_decay=0.0001)
