...
class Teacher_cam_DetectionDistiller(BaseDetector):
    ...
    def __init__(self,
        ...
        super(Teacher_cam_DetectionDistiller, self).__init__()
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_bboxes_ignore=None, **kwargs):
        ...
        for i, item_loc in enumerate(self.distill_cfg):
            ...
            for item_loss in item_loc.methods:
                ...
                student_loss[loss_name] = self.distill_losses[loss_name](student_feat,teacher_feat, teacher_cam_mask_per_layer[i], gt_bboxes, img_metas)
