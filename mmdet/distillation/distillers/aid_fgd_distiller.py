...
class AID_DetectionDistiller(BaseDetector):
    ...
    def __init__(self,
        ...
        super(AID_DetectionDistiller, self).__init__()
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        with torch.no_grad():
            ...
            losses_T = self.teacher.forward_train(img, img_metas, **kwargs)
        ...
        for item_loc in self.distill_cfg:
            ...
            for item_loss, _i in zip(item_loc.methods, range(0,4)):
                ...
                student_loss[loss_name] = w * self.distill_losses[loss_name](student_feat,teacher_feat,kwargs['gt_bboxes'], img_metas)
