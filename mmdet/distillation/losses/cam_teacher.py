...
class Teacher_Cam_FeatureLoss(nn.Module):
    ...
    def __init__(self,
        ...
        super(Teacher_Cam_FeatureLoss, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        fg_loss, bg_loss = self.get_fea_loss(preds_S, preds_T, Mask_fg, Mask_bg, Mask_cam_T,
    ...
    def get_fea_loss(self, preds_S, preds_T, Mask_fg, Mask_bg, Mask_cam_T, Mask_cam_S, C_s, C_t, S_s, S_t):
        ...
        fg_fea_s = torch.mul(fg_fea_s, torch.sqrt(Mask_cam_T))
