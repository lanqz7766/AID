...
class Cam_only_no_gmask_FeatureLoss(nn.Module):
    ...
    def __init__(self,
        ...
        super(Cam_only_no_gmask_FeatureLoss, self).__init__()
        self.temp = temp
    ...
    def forward(self,
        ...
        # logger.info(f'preds_S shape is: {preds_S.size()}')
        # logger.info(f'cam_masks_S shape is: {cam_masks_S.size()}')
