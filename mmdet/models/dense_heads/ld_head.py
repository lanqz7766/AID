...
class LDHead(GFLHead):
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, labels, label_weights,
                    bbox_targets, stride, soft_targets, soft_label, num_total_samples):
        ...
        return loss_cls, loss_bbox, loss_dfl, loss_ld, loss_kd, weight_targets.sum()
    ...
    def forward_train(self,
        ...
        """
        outs = self(x)
        soft_label = out_teacher[0]
        soft_target = out_teacher[1]
        if gt_labels is None:
            loss_inputs = outs + (gt_bboxes, soft_target, soft_label, img_metas)
        else:
            loss_inputs = outs + (gt_bboxes, gt_labels, soft_target, soft_label, img_metas)
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_dfl, losses_ld, losses_kd, \
