...
class M3KnowledgeDistillationSingleStageDetector(SingleStageDetector):
    ...
    def forward_train(self,
        ...
        w1 = torch.exp(-T_total_1)/(torch.exp(-T_total_1)+torch.exp(-T_total_2)+torch.exp(-T_total_3))
        w2 = torch.exp(-T_total_2)/(torch.exp(-T_total_1)+torch.exp(-T_total_2)+torch.exp(-T_total_3))
